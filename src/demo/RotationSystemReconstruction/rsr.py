...
if len(argv) > 1:
    ...
    print(f"Loaded {len(vertices)} vertices and {len(normals)} normals from {argv[1]}")
    m = rsr_recon(vertices, normals, collapse_iters=4, use_Euclidean_distance=True, genus=0, k=70, r=20, theta=60, n=50)
