...
DLLEXPORT void graph_minimum_spanning_tree(Graph_ptr g_ptr, Graph_ptr mst_ptr, int root);
DLLEXPORT void graph_close_chordless_cycles(Graph_ptr g_ptr, int root, int hops, double rad);
