...
const F& functor,
	...
	template<class T, class F>
	void for_each_voxel(RGrid<T>& grid,	const F& functor)
	{
	...
	*/ 
	...
	template<class T, class F>
	void for_each_voxel_ordered(RGrid<T>& grid,	const F& functor)
	{
		_for_each_voxel(grid.get(), grid.get_dims(), functor);
	}
	...
	public:
		_HGridCellFunctor(const CGLA::Vec3i _p0,
											...
											const F& _functor): p0(_p0), p7(_p7), functor(_functor) {}
	...
	template<class T, class CellT, class F>
	void for_each_voxel(HGrid<T,CellT>& grid, const F& functor)
	{
	...
	template<class T, class CellT, class F>
	void for_each_voxel_ordered(HGrid<T,CellT>& grid, const F& functor)
	{
	...
	/** Loop over all voxels in an entire	RGrid. 
			...
			specified by the functor is performed. */
	template<class T, class F>
	void for_each_voxel_const(const RGrid<T>& grid,	const F& functor)
	{
		_for_each_voxel(grid.get(), grid.get_dims(), functor);
	}
	...
	*/ 
	...
	template<class T, class F>
	void for_each_voxel_ordered_const(const RGrid<T>& grid,	const F& functor)
	{
		_for_each_voxel(grid.get(), grid.get_dims(), functor);
	}
	...
	template<class T, class CellT, class F>
	void for_each_voxel_const(const HGrid<T,CellT>& grid, const F& functor)
	{
	...
	template<class T, class CellT, class F>
	void for_each_voxel_ordered_const(const HGrid<T,CellT>& grid, const F& functor)
	{
