...
public:
    ...
    constexpr ArithVec3Float(T a, T b, T c): ArithVecFloat<T, V, 3>(a, b, c) {}

    /// Construct a 3D float vector.
    constexpr ArithVec3Float() = default;
...
/// @related ArithVec3Float
/// @{

/// Returns cross product of arguments
template <class T, class V>
constexpr V cross(const ArithVec3Float<T, V>& x,
